...
st.markdown(
    '<div class="title1">SIRAS-Brazil</div>', unsafe_allow_html=True)

st.markdown(
    '<div class="title2">System for the Interactive Review and Analysis of Flash Droughts in Brazil</div>', unsafe_allow_html=True)
...
<div style="text-align:center; margin-top:20px; display:flex; justify-content:center; gap:22px; align-items:center; flex-wrap:wrap;">
  ...
  <div style="text-align:center;">
    ...
    <a href="https://engineering.tamu.edu/civil/index.html" target="_blank" rel="noopener noreferrer">
      <img src="https://d26fti783qamsb.cloudfront.net/wp-content/uploads/2024/05/19171707/TAM-MaroonBox-1.png" style="height:100px; display:block; margin:4px auto;">
    </a>
  </div>
